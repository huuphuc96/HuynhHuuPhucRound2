...
{
    //Replace IMemoryCache with a distributed cache if you are in multi-host scenario
    public class RevokeAuthenticationEvents : CookieAuthenticationEvents
    {
        ...
        public override async Task ValidatePrincipal(CookieValidatePrincipalContext context)
        {
            ...
            var identityKey = context.Request.Cookies[CookieSettingConfiguration.IdentifierCookieName];
